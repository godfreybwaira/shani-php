...
namespace gui {
    ...
    final class WebUI2
    {
         ...
         * @return void
         */
        public static function render(App $app, UIBuilder $builder): void
        {
            if ($app->config->isAsync()) {
                self::load($app, $app->view($builder->view()));
            } else {
                self::load($app, Framework::DIR_GUI . '/html/main.php');
            }
        }
