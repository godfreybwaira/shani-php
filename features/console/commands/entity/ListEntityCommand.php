...
/**
 * Command to list all entities (models) of a project module.
 *
 * This command retrieves all entities associated with a given module
    ...
    final class ListEntityCommand extends CommandContract
    {
        ...
        public function __construct(CommandRegistry $registry)
        {
            parent::__construct(
                    ...
                    'Show all the existing project entities (models) in a given module',
                    'blog@v1@posts'
            );
        }

        /**
         * Executes the entity listing operation.
         *
         * Uses the {@see ModuleBuilder} to build the module and retrieves
         * all entities. Each entity is formatted and added to the registry.
         *
         * @return void
         */
        public function execute(): void
        {
            ...
            foreach ($entities as $key => $entity) {
                $this->registry->addResult(
                        Formatter::formatSentence($key + 1, $entity->entityName)
                );
            }
        }
