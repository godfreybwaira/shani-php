...
namespace features\console\commands\version {
    ...
    final class StartVersionCommand extends CommandContract
    {
        ...
        public function __construct(CommandRegistry $registry)
        {
            parent::__construct(
                    ...
                    'Run the application version that was stopped before',
                    'blog@v1'
            );
        }
        ...
        public function execute(): void
        {
            ...
            $version->start(fn($s) => $this->registry->addResult($s));
        }
