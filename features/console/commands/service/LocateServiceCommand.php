...
/**
 * Command to locate a project service.
 *
 * This command shows the filesystem path to the services of a given project module.
 * It can be executed interactively (via console prompts) or by passing arguments
 * directly in the format "project@version@module".
 *
 * @author goddy
...
namespace features\console\commands\service {
    ...
    final class LocateServiceCommand extends CommandContract
    {
        ...
        /**
         * The name of the project whose services are being located.
         *
         * @var string
         */
        ...
        public function __construct(CommandRegistry $registry)
        {
            parent::__construct(
                    ...
                    'Show the full path to an existing project services',
                    'blog@v1@posts'
            );
        }
         ...
         * {@see ServiceBuilder} to locate the services path.
         *
         * @return void
         */
