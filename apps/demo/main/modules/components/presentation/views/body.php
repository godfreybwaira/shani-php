<div class="tab tab-pos-b">
    <div class="tab-menu menubar" id="parent1" shani-on="ui-select->ui.select active-class:active">
        <a href="/components/0/generator" shani-cache="age:5s"
        ...
        <a href="/components/0/all" shani-on="click->util.trigger ui-select>>#parent1;util.trigger->http.pull>>#content" class="menu-item">
            <i class="mdi mdi-tab"></i>
            <span class="font-sm menu-label">Components</span>
        </a>
        <a href="/components/0/containers"
           shani-on="click->util.trigger ui-select>>#parent1;util.trigger->http.pull>>#content" class="menu-item">
            <i class="mdi mdi-rectangle"></i>
            <span class="font-sm menu-label">Containers</span>
        </a>
        <a href="/components/0/inputs" data-read="mode:@data-mode"
           shani-on="click->util.trigger ui-select>>#parent1;util.trigger->http.pull @data-read>>#content;" data-mode="replace"
           shani-headers="@data-headers" class="menu-item">
            <i class="mdi mdi-inbox-full"></i>
            <span class="font-sm menu-label">Inputs</span>
        </a>
        <a href="/components/0/bindings" shani-on="click->util.trigger ui-select>>#parent1;
        ...
        <a href="/components/0/nodes" shani-on="click->util.trigger ui-select>>#parent1;
           util.trigger->http.pull outputf:data-formatter>>#content" class="menu-item">
            <i class="mdi mdi-sitemap"></i>
            <span class="font-sm menu-label">Nodes</span>
        </a>
    </div>
