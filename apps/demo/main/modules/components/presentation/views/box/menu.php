<div class="menubar accent-color" id="sidemenu" shani-on="ui-select->ui.select active-class:active">
    ...
    <a href="/components/0/stream" shani-http="@data-conn" data-conn="name:@http-name"
       shani-on="click->util.trigger ui-select>>#sidemenu;
    ...
    <a href="/components/0/generator" class="menu-item menu-item-dir-v"
       shani-on="click->util.trigger ui-select>>#sidemenu;
    ...
    <a href="/components/0/card" class="menu-item menu-item-dir-v" data-headers="content-type:application/json"
       shani-on="click->util.trigger ui-select>>#sidemenu;
