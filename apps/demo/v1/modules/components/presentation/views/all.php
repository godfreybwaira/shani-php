...
<ul>
    <li>
        <a href="/components/0/toaster?type=t" shani-on="click->http.pull mode:append>>body">
            Toaster from Top
        </a>
    </li>
    <li>
        <a href="/components/0/toaster?type=b" shani-on="click->http.pull mode:append>>body">
            Toaster from Bottom
        </a>
    </li>
</ul>
...
<div class="row">
    <div class="col">
        <ul class="timeline" shani-on="demand steps:3s->http.pull mode:append>>.timeline" shani-http="url:@action" action="/components/0/timeline">
            <li>
                <h3>My Title</h3>
