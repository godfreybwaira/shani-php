<div class="toaster color-alert pos-tc width-md-5 padding-xy">
...
<div class="tab tab-pos-b">
    <div class="tab-menu menubar" shani-fn="select" shani-class="active blur">
        ...
        <a href="#" class="active menu-item menu-item-dir-h">
    ...
    <div class="tab-body">
        <div class="padding-xy">
            ...
            <div class="divider color-2">Carousel</div>
            ...
            <div class="divider color-2">Rows</div>
            ...
            <div class="table-container">
                <table class="table border-h">
                    ...
                    <tbody id="users" class="stripes-even">
                        <tr>
