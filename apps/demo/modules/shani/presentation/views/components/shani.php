<div class="tab tab-pos-b">
    <div class="tab-menu menubar">
        <a href="/shani/0/components/0/redirect" shani-on="click->ui.select active-class:active;ui.select->http.pull>>#shani_demo;" class="active menu-item">
    ...
    <div class="tab-body container" id="shani_demo">
        Shani
    </div>
</div>
<button shani-on="click->ui.close>>.modal-background" class="button button-times pos-tr" style="margin: var(--spacing)">&times;</button>
