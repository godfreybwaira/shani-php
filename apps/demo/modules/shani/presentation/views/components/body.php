<div class="tab tab-pos-b">
    <div class="tab-menu menubar" id="parent1" shani-on="ui-select->ui.select active-class:active">
        <a href="/shani/0/components/0/generator" shani-cache="age:5s"
           ...
           shani-on="click->util.trigger ui-select>>#parent1;util.trigger->http.pull>>#content;httpend->ui.loader.rmv>>#content;
           httpstart->ui.loader name:loader-spin&size:2.5rem>>#content;">
            <i class="mdi mdi-cog"></i>
            <span class="font-sm menu-label">Generator</span>
        </a>
        <a href="/shani/0/components/0/all" shani-on="click->util.trigger ui-select>>#parent1;util.trigger->http.pull>>#content" class="menu-item">
        ...
        <a href="/shani/0/components/0/nodes" shani-on="click->util.trigger ui-select>>#parent1;
           util.trigger->http.pull outputf:data-formatter>>#content" class="menu-item">
