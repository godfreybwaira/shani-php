        ...
        <div class="dropdown">
            ...
            <div class="dropdown-body pos-tr">
                <div class="list">
                    ...
                    <a href="#">My list item 2</a>
                    <a href="#">My longest list item 3</a>
                    <a href="#">List 4</a>
                </div>
            </div>
        </div>
...
<div class="divider">Horizontal Step</div>
<div class="row">
    <div class="col">
        <ul class="step">
...
<div class="divider">Menubar without Icon</div>
<div class="row row-stretch">
    <div class="col">
        <div class="menubar color-alert">
            <a href="#" class="menu-item">
...
<div class="divider">Menubar without Labels</div>
<div class="row row-stretch">
    <div class="col">
        <div class="menubar color-alert">
...
<ul>
    <li>
        <a href="/shani/0/components/0/toaster?type=t" shani-on="click:read append>>body">
            Toaster from Top
        </a>
    </li>
    <li>
        <a href="/shani/0/components/0/toaster?type=b" shani-on="click:read append>>body">
            Toaster from Bottom
        </a>
    </li>
</ul>
...
<ul>
    <li>
        <a href="/shani/0/components/0/loader?type=i" shani-on="click:read append>>.layout-content">
            Infinite loader
        </a>
    </li>
</ul>
...
<div class="row">
    <div class="col">
        <ul class="timeline" shani-on="demand:read append>>.timeline" shani-timer="0s:3s" action="/shani/0/components/0/timeline">
            <li>
                <h3>My Title</h3>
