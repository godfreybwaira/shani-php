...
<ul>
    <li>
        <a href="/shani/0/components/0/toaster?type=t" shani-on="click:r append>>body">
            Toaster from Top
        </a>
    </li>
    <li>
        <a href="/shani/0/components/0/toaster?type=b" shani-on="click:r append>>body">
            Toaster from Bottom
        </a>
    </li>
</ul>
...
<ul>
    <li>
        <a href="/shani/0/components/0/loader?type=i" shani-on="click:r append>>.layout-content">
            Infinite loader
        </a>
    </li>
</ul>
...
<div class="row">
    <div class="col">
        <ul class="timeline" shani-on="demand:r append>>.timeline" shani-timer="0:3" action="/shani/0/components/0/timeline">
            <li>
                <h3>My Title</h3>
