...
<div class="divider">Horizontal Cards</div>
...
<div class="row">
    <div class="col color-4 width-md-half">Col1</div>
    <div class="col color-8 width-md-half">Col2</div>
</div>
<div class="row">
...
<div class="row">
    <div class="col color-4 width-md-1q">A quarter sized column</div>
    <div class="col color-16 width-md-1q">A quarter sized column</div>
    <div class="col color-12 width-md-half">A half sized column</div>
</div>
<div class="row">
    ...
    <div class="col color-12 width-md-half">Col4</div>
</div>
...
<div class="row row-no-gap row-stretch">
    <div class="col color-4 width-md-1q">Col1</div>
    <div class="col color-16 width-md-1q">Col2</div>
    <div class="col color-12 width-md-half">Col3</div>
</div>
<div class="row row-no-gap row-stretch">
    <div class="col color-4 width-md-2">Col1</div>
    <div class="col color-16 width-md-2">Col2</div>
...
<div class="row">
    <div class="col width-md-half width-sm-max">
        <div class="tab tab-pos-t borders">
            ...
            <div class="tab-body">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat, ipsam, voluptatum, laudantium, iusto maiores odit expedita eveniet tenetur modi quia unde ex cupiditate vero corrupti libero est ad debitis nihil.
            </div>
        </div>
    </div>
    <div class="col width-md-half width-sm-max">
...
<div class="row">
    <div class="col width-sm-max width-md-half">
        <div class="row">
            <div class="col">
        ...
        <ul class="list borders">
            <li>
                <div class="row row-nowrap">
                    ...
                    <div class="col">
                        <a href="#">Godfrey Bwaira</a>
                        <div class="list-body">Some details goes here</div>
                    </div>
                </div>
            </li>
            <li>
...
<div class="row">
    <div class="col">
        <button class="button color-alert"
                shani-on="click::numberbind thatprop:value&value&precision:2&format:true&operator:+>>#plus10" value="10000">
            Add By 10
        </button>
    </div>
    <div class="col">
    ...
    <div class="col">
        <button class="button color-alert" shani-on="click::numberbind thatprop:value&format:true&value&operator:->>#plus10" value="10">
            Minus 10
        </button>
    </div>
    <div class="col">
        <button class="button color-alert" value="10" shani-on="click::numberbind thatprop:value&value&operator:*>>#mulby10">
            Multiply by 10
        </button>
    </div>
    <div class="col">
    ...
    <div class="col">
        <button class="button color-alert" value="10" shani-on="click::numberbind value&precision:5&operator:/>>#mulby10">
            Divide by 10
        </button>
    </div>
</div>
<div class="row">
    <div class="col">
        <button class="button color-alert" value="10" shani-on="click::numberbind value&precision:5&operator:%>>#remby10">
            Reminder By 10
        </button>
    </div>
    <div class="col">
    ...
    <div class="col">
        <button class="button color-alert" value="2" shani-on="click::numberbind value&precision:5&format:true&operator:^>>#powby2">
            Power 2
        </button>
    </div>
    <div class="col">
    ...
    <div class="col">
        <button class="button color-alert" value="10%" shani-on="click::numberbind value&precision:5&operator:+>>#addpct10">
            Add 10%
        </button>
    </div>
    <div class="col">
