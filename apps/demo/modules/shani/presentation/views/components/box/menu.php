<div class="menubar accent-color">
    ...
    <a href="/shani/0/components/0/generator" class="menu-item menu-item-dir-v"
       shani-on="click::loadercreate
       name:loader-spin&color:#000&size:2.5rem>>.layout-container;
    ...
    <a href="/shani/0/components/0/card" class="menu-item menu-item-dir-v" type="application/json"
       shani-on="click::modalcreate
       id:mdl123&classes:modal modal-type-c width-sm-10 height-sm-10 pos-c&close-btn:pos-tr;
