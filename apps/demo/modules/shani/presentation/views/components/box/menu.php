<div class="menubar accent-color">
    <a href="/" shani-on="click:r" shani-target="#mainbody" class="active menu-item menu-item-dir-v">
        <i class="mdi mdi-home"></i>
        <span class="font-sm menu-label">Home</span>
    </a>
    <a href="/shani/0/components/0/shani"
       shani-on="click:r" shani-target="#mainbody" class="menu-item menu-item-dir-v">
    ...
    <a href="/shani/0/components/0/containers" ui-class="modal modal-type-v width-md-1q width-sm-10 pos-r"
       shani-on="click:r" ui-data="close:pos-tl" class="menu-item menu-item-dir-v">
