<div class="menubar accent-color">
    ...
    <a href="/shani/0/components/0/stream" shani-http="conn:aaa"
       shani-on="click::loaderadd<<name:loader-top&color:red&size:.2rem>>.layout-content;
       loaderadd::abortconn<<name:aaa;abortconn::read<<mode:replace>>#content;
    ...
    <a href="/shani/0/components/0/generator" class="menu-item menu-item-dir-v"
       shani-on="click::loaderadd<<name:loader-top&size:.2rem>>.layout-content;
       cssadd::read>>#content;httpend::loaderrmv>>.layout-content">
        <i class="mdi mdi-loading"></i>
        <span class="font-sm menu-label">Loader 1</span>
    </a>
    <a href="/shani/0/components/0/generator" class="menu-item menu-item-dir-v"
       shani-on="click::loaderadd<<name:loader-spin&color:#000&size:2.5rem>>.layout-container;
       loaderadd::abortconn<<name:aaa;
    ...
    <a href="/shani/0/components/0/card" class="menu-item menu-item-dir-v"
       ...
       makemodal::read<<mode:replace>>#mdl123; 408::timeout; httpend::loaderrmv>>#mdl123;
       httpstart::loaderadd<<name:loader-spin&size:2.5rem>>#mdl123;
